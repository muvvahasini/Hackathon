            ...
            <div className="container">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-xl font-bold">GreenFarm</span>
                        </div>
                        <p className="text-gray-400 mb-4">
                            Connecting sustainable farmers with conscious consumers.
                            Fresh, local, and organic products delivered to your doorstep.
                        </p>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8 text-center">
                    <p className="text-gray-400">
                        © 2024 GreenFarm. All rights reserved. Made with ❤️ for sustainable farming.
                    </p>
                </div>
            </div>
        </footer>
